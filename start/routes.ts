...
Route.post('/corporates-gets', 'CorporatesController.get')
Route.get('/corporates-gets/:id', 'CorporatesController.get')
Route.get('/corporates-getlists', 'CorporatesController.getAll')
